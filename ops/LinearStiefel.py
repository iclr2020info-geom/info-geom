...
class LinearStiefel(Linear):
    ...
    Attributes:
        weight: the learnable weights of the module of shape
            ...
            WARNING! This breaks with pytorch convention but
            is necessary for the manifold optimizer to keep
            the columnspace of A orthogonal.
    ...
    def reset_parameters(self):
        self.weight.data = stiefel.random(self.weight.size())
        if self.bias is not None:
            self.bias.data.zero_()


class LinearGeneralizedStiefel(LinearStiefel):
    r"""Applies a linear transformation to the incoming data: :math:`y = A'x + b`
